            ...
            <View style={styles.container}>
                {
                    ...
                    ?<View style={styles.card} >
                        <View style={styles.imgContainer} >
                            <Image style={styles.img} source={ require('../images/shoulder-workout.jpg')} />
                            <Text style={styles.day} > Wednesday
                         </Text>
                        ...
                        <ScrollView showsVerticalScrollIndicator={false} >
                            ...
                            <WorkOut name="MC Press" details="2-3-4" />
                            <WorkOut name="Side Lateral" details="18-18-24" />
                            <WorkOut name="DB Press" details="5-5-5" />
                            <WorkOut name="Upright Row" details="18-18-18" />
                        </ScrollView>
                        </View>
