            ...
            <View style={styles.container}>
                {
                    ...
                    ?<View style={styles.card} >
                        <View style={styles.imgContainer} >
                            <Image style={styles.img} source={ require('../images/lat-workout.jpg')} />
                            <Text style={styles.day} > Friday </Text>
                            <View style={styles.titleBox} >
                                <Text style={styles.title} > Lat Workout </Text>
                            </View>
                        </View>
                        ...
                        <ScrollView showsVerticalScrollIndicator={false} >
                            ...
                            <WorkOut name="Lat Pull Down" details="2-3-4" />
                            <WorkOut name="Mid Row" details="18-18-24" />
                            <WorkOut name="DB Row" details="5-5-5" />
                            <WorkOut name="Reverse Pull Down" details="18-18-18" />
                        </ScrollView>
                        </View>
